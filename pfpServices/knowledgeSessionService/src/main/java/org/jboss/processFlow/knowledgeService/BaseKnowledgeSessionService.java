 ...
 *</pre>
 */
public class BaseKnowledgeSessionService {
    ...
    protected Logger log = Logger.getLogger(BaseKnowledgeSessionService.class);
    ...
    protected @javax.annotation.Resource(name="java:/TransactionManager") TransactionManager tMgr;
...
*************              Process Definition Management              *********/
    ...
    protected void addNodesInfo(List<SerializableNodeMetaData> snList, Process processObj, SerializableProcessMetaData processMeta, String prefix) {
